...
@Module
public class ApiModuleForTopmovies {
    ...
    @Provides
    public ApiServiceForTopmovies provideApiService() {
        return provideRetrofit(BASE_URL, provideClient()).create(ApiServiceForTopmovies.class);
    }
}
